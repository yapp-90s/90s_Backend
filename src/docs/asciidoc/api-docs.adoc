...
----
필름 관련한 API 입니다. 필름 만들기, 필름에 사진 추가 등이 있습니다. 모든 요청은 JWT를 Header에 포함해서 보내주세요.
----
...
|===
| 기능 | 방식 | URI
| 로그인 | Post | film/download
|===

===== CurlRequest
include::{snippets}/film-controller-test/download_photo/curl-request.adoc[]
===== httpRequest
include::{snippets}/film-controller-test/download_photo/http-request.adoc[]


===== Response
include::{snippets}/film-controller-test/download_photo/http-response.adoc[]